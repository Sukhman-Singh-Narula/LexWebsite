...
import { fetchCase, selectSelectedCase, selectCasesLoading } from '../features/cases/caseSlices';
        ...
        <div className="p-6">
            ...
            <div className={`mb-6 ${darkMode ? 'text-white' : 'text-gray-900'}`}>
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                    ...
                    <div className={`px-3 py-1 rounded-full text-xs font-medium ${selectedCase?.status === 'active' ? 'bg-blue-100 text-blue-800' :
                ...
                <div className="mt-2 flex space-x-4">
                    <a
                        href="#documents"
                        className={`inline-flex items-center gap-1 border-b-2 py-2 text-sm font-medium ${darkMode
